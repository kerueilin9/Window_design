...
namespace DrawingFormUITest
{
    public class Robot
    {
        ...
        // test
        public void ClickElementById(string name)
        {
        ...
        // test
        [Obsolete]
        public void DragAndDrop(string name, double positionX1, double positionY1, double positionX2, double positionY2)
        {
            var canvas = _driver.FindElementByAccessibilityId(name);
            _driver.Mouse.MouseMove(canvas.Coordinates, (int)(positionX1 * 1.25), (int)(positionY1 * 1.25));
            _driver.Mouse.MouseDown(null);
            _driver.Mouse.MouseMove(canvas.Coordinates, (int)(positionX2 * 1.25), (int)(positionY2 * 1.25));
            _driver.Mouse.MouseUp(null);
        }

        // test
        [Obsolete]
        public void ClickOnCanvas(string name, double positionX, double positionY)
        {
            var canvas = _driver.FindElementByAccessibilityId(name);
            _driver.Mouse.MouseMove(canvas.Coordinates, (int)(positionX * 1.25), (int)(positionY * 1.25));
            _driver.Mouse.MouseDown(null);
            _driver.Mouse.MouseUp(null);
        }
