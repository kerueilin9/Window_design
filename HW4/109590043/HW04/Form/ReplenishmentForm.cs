...
namespace Homework
{
    ...
    {
        private SupplementFormPresentationModel _presentationModel;
        ...
        {
            _presentationModel = new SupplementFormPresentationModel(model);
            this._model = model;
        ...
        {
            this._bookItem.SetPlusBookCount(_presentationModel.ReturnCount(this._textSupplyCount.Text));
